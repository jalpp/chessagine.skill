...
The ChessAgine skill enables Claude to be a chess buddy and analyst by leveraging 40+ specialized tools from the ChessAgine MCP server. This skill provides:
